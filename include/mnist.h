...
#define TEST_IMAGE "/tmp/tmp.3nS42pXqhM/res/t10k-images-idx3-ubyte"
#define TEST_LABEL "./data/t10k-labels.idx1-ubyte"


//    std::string imageFile = "/tmp/tmp.3nS42pXqhM/res/t10k-images-idx3-ubyte";
//    std::string labelFile = "/tmp/tmp.3nS42pXqhM/res/t10k-labels-idx1-ubyte";z
...
void read_mnist_char(char *file_path, int num_data, int len_info, int arr_n, unsigned char data_char[][SIZE], int info_arr[])
{
    int i, j, k, fd;
    unsigned char *ptr;
...
void image_char2float(int num_data, unsigned char data_image_char[][SIZE], double data_image[][SIZE])
{
    int i, j;
    for (i=0; i<num_data; i++)
        for (j=0; j<SIZE; j++)
...
//    label_char2int(NUM_TEST, test_label_char, test_label); //TODO
}
